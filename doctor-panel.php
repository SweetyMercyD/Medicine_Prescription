...
if (isset($_POST['token'])) {
    ...
    echo $fileid = $_POST['fileid'];
    $Currentstamp = date('Y-m-d H:i:s');
    echo $query = "SELECT * FROM lab WHERE id = '" . $fileid. "' ";
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Prescription List</a>
         <a class="list-group-item list-group-item-action" href="#list-Laboratory" id="list-Laboratory-list" role="tab" data-toggle="list" aria-controls="home">Laboratory Report</a>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-home-list">
      ...
      <div class="tab-pane fade" id="list-Laboratory" role="tabpanel" aria-labelledby="list-Laboratory-list">
