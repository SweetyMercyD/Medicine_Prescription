                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 60%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#Prescribe" role="tab" aria-controls="Prescribe" aria-selected="false">Prescribe</a>
                            </li>

                                <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#lab" role="tab" aria-controls="lab" aria-selected="false">Lab</a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show" id="lab" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Lab Assistant Team</h3>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="lab" value="Login"/>
                                    </div>
                        ...
                        <div class="tab-pane fade show" id="Prescribe" role="tabpanel" aria-labelledby="profile-tab">
                                <h3  class="register-heading">Prescribe Team</h3>
                                <form method="post" action="func3.php">
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="submit" class="btnRegister" name="prescribe" value="Login"/>
                                    </div>
